...
// принимает номер устройства управления, 
// возвращает строку с названием этого устройства управления
...
// изменяет тип управления у конкретного игрока
...
// задает аттрибуты виджета с вьювером
